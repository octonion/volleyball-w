...
conn = PGconn.open(:dbname => 'volleyball-w')
...
#ncaa_team_schedules = CSV.open("tsv/ncaa_team_schedules.tsv","r",{:col_sep => "\t", :headers => TRUE})

if (File.file?("tsv/ncaa_games_play_by_play_mt_update.tsv"))
  ncaa_play_by_play = CSV.open("tsv/ncaa_games_play_by_play_mt_update.tsv","a",{:col_sep => "\t"})
else
  ncaa_play_by_play = CSV.open("tsv/ncaa_games_play_by_play_mt_update.tsv","w",{:col_sep => "\t"})
...
if (File.file?("tsv/ncaa_games_periods_mt_update.tsv"))
  ncaa_periods = CSV.open("tsv/ncaa_games_periods_mt_update.tsv","a",{:col_sep => "\t"})
else
  ncaa_periods = CSV.open("tsv/ncaa_games_periods_mt_update.tsv","w",{:col_sep => "\t"})
