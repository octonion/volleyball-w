...
for row in rows:
    ...
    n = 12
    we25 = 1 - p*comb(4*n, 2*n)*(p*q)**(2*n)*hyp2f1(1,4*n+1,2*n+1,q)
    le25 = 1 - q*comb(4*n, 2*n)*(p*q)**(2*n)*hyp2f1(1,4*n+1,2*n+1,p)
    ...
    n = 7
    we15 = 1 - p*comb(4*n, 2*n)*(p*q)**(2*n)*hyp2f1(1,4*n+1,2*n+1,q)
    le15 = 1 - q*comb(4*n, 2*n)*(p*q)**(2*n)*hyp2f1(1,4*n+1,2*n+1,p)
