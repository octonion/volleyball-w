...
create table if not exists ncaa_pbp._schedule_factors (
        school_id		integer,
	year			integer,
        offensive               float,
        defensive		float,
...
truncate table ncaa_pbp._schedule_factors;
...
where r.year between 2014 and 2017
);
...
strength=o.strength
from ncaa_pbp._schedule_factors o
